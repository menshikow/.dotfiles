...
(use-package diminish
  :after (eglot flymake whitespace)
  :config
  (diminish 'eglot-mode)
...
;; (if (file-exists-p "~/.emacs.d/themes/less-theme/")
;;     (load-theme 'less t)
;;   (load-theme 'wombat t))
...
(use-package evil-mc
  ...
  ;; Bindings for spawning cursors (gz prefix)
  (general-define-key
   :states '(normal visual)
   "gzm" #'evil-mc-make-cursor-here
   "gzn" #'evil-mc-make-and-goto-next-match
   "gzp" #'evil-mc-make-and-goto-prev-match
   "gzu" #'evil-mc-undo-last-added-cursor))
...
(use-package general
  ...
  (my-leader-def
    ...
    ;; Multiple Cursors Leader
    "m"   '(:ignore t :which-key "multiple-cursors")
    "ma"  '(evil-mc-make-all-cursors :which-key "make all")
    "mp"  '(evil-mc-pause-cursors :which-key "pause")
    "mr"  '(evil-mc-resume-cursors :which-key "resume")
...
;; VERILOG CONFIGURATION (Corrects .v association & enables Autos)
